...
//             <Input placeholder="Search to Menu..." className="pl-10 py-2 border-gray-300 rounded-md w-full" />
...
//           <h2 className="text-sm text-gray-600">How Many Appointments Do We Have?</h2>
//           <div className="flex items-center gap-2">
//             <Select defaultValue="week">
//               <SelectTrigger className="h-8 text-xs bg-transparent border-none shadow-none">
...
//                   <div className="w-3/5 bg-gray-200 h-2 rounded-full overflow-hidden">
...
//               <SelectTrigger className="h-8 text-xs bg-teal-600 text-white border-none rounded-md px-3">
//                 <SelectValue placeholder="Timeframe" />
//               </SelectTrigger>
//               <SelectContent>
//                 <SelectItem value="week">Week</SelectItem>
...
//                   <span className="text-gray-500 border-b-2 border-gray-800">Previous</span>
//                 </div>
//                 <Select defaultValue="week">
//                   <SelectTrigger className="h-6 text-[10px] bg-transparent border-none shadow-none">
...
//                 <BarGroup values={[30, 45]} colors={["#6B7280", "#F97316"]} />
...
//           <Button className="bg-teal-600 hover:bg-teal-700 text-white rounded-md text-sm">+ Add to Dashboard</Button>
//         </div>
//       </div>
//     </div>
//   )
    ...
    <div className="min-h-screen mt-10 bg-[#fdfbf6] p-2">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        {/* <div className="flex justify-between items-center mb-2">
          <h2 className="text-sm text-gray-600">How Many Appointments Do We Have?</h2>
          <div className="flex items-center gap-2">
            <select className="h-8 text-xs bg-transparent border-none">
