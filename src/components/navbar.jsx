...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <section className="fixed top-0 left-0 right-0 lg:z-50 flex flex-col justify-center w-full mt-3">
      <div className={`bg-red-500 flex justify-between items-center px-1 py-1 h-[57px] transition-all duration-300
      ${sidebar ? `lg:w-[calc(100vw-17.5rem)] lg:ml-auto mr-3` : `lg:w-[calc(100vw-4.6rem)] lg:ml-auto mr-3`}
    `}>
